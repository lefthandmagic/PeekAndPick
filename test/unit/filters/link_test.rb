...
class LinkTest < Test::Unit::TestCase
  ...
  def test_transform_with_the_slash_at_the_end
    result = auto_html("https://github.com/") { link }
    assert_equal '<a href="https://github.com/" >https://github.com/</a>', result['value']
  end

  def test_transform_with_param
    result = auto_html('http://example.com/abc?query=ruby') { link }
    assert_equal '<a href="http://example.com/abc?query=ruby" >http://example.com/abc?query=ruby</a>', result['value']
  end
  ...
  def test_transform_with_anchor_and_trailing_dot
    ...
    assert_equal '<a href="http://example.com/example#id=123.12" >http://example.com/example#id=123.12</a>.', result['value']
  end
  ...
  def test_transform_with_commas
    ...
    assert_equal '<a href="http://www.dw-world.de/dw/article/0,,4708386,00.html?maca=ser-rss-ser-all-1494-rdf" >http://www.dw-world.de/dw/article/0,,4708386,00.html?maca=ser-rss-ser-all-1494-rdf</a>', result['value']
  end
  ...
  def test_transform_with_options
    ...
    assert_equal '<a href="http://rors.org" target="_blank">http://rors.org</a>', result['value']
  end
