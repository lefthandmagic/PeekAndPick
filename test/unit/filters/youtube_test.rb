...
class YouTubeTest < Test::Unit::TestCase
  ...
  def test_transform
    ...
    assert_equal '<iframe class="youtube-player" type="text/html" width="390" height="250" src="http://www.youtube.com/embed/BwNrmYRiX_o" frameborder="0"></iframe>', result['value']
  end
  ...
  def test_transform_with_options
    ...
    assert_equal '<iframe class="youtube-player" type="text/html" width="300" height="255" src="http://www.youtube.com/embed/BwNrmYRiX_o" frameborder="1"></iframe>', result['value']
  end
