...
class ImageTest < Test::Unit::TestCase
  ...
  def test_transform
    ...
    assert_equal 'http://rors.org/images/rails.png', result['value']
  end
  ...
  def test_transform2
    ...
    assert_equal 'http://farm4.static.flickr.com/3459/3270173112_5099d3d730.jpg', result['value']
  end

  def test_transform3
    result = auto_html('http://www.lockhartfineart.com/images/Rio_Grande_Frost.JPG') { image({:alt => nil}) }
    assert_equal 'http://www.lockhartfineart.com/images/Rio_Grande_Frost.JPG', result['value']
  end
  ...
  def test_transform5
    ...
    assert_equal 'http://farm4.static.flickr.com/3664/3512431377_71b8d002ef.jpg?v=0', result['value']
  end
  ...
  def test_transform7
    ...
    assert_equal 'http://tbn3.google.com/images?q=tbn:vS-jtEi9Xc8K6M:http://upload.wikimedia.org/wikipedia/commons/b/ba/Potturinn.jpeg', result['value']
  end

  def test_https
    result = auto_html('https://img.skitch.com/20100910-1wrbg5749xe29ya5t3s85bnaiy.png') { image({:alt => nil}) }
    assert_equal 'https://img.skitch.com/20100910-1wrbg5749xe29ya5t3s85bnaiy.png', result['value']
  end
